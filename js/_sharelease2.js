...
async function delegateShareLease(inputAmnt){
	...
	//estimate gasLimit
	var encodedData = tokenInst.methods.delegateShares(delegateAmnt).encodeABI();
	...
	//Send
	tokenInst.methods.delegateShares(delegateAmnt).send({from: MyLibrary.wallet, gasPrice: gasPrice, gasLimit: parseInt(estimateGas)})
...
tokenInst.events.DelegateLease()
	.on('data', async function(event){
		...
		var nonTxAction = leaseTokens + ' Tokens';
